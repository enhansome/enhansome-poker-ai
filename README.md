...
* [PokerKit](https://github.com/uoftcprg/pokerkit) ⭐ 486 | 🐛 0 | 🌐 Python | 📅 2026-05-22 — Comprehensive Python library supporting Texas Hold'em, Omaha, Stud, Razz, and custom game variants (University of Toronto). [Paper](https://arxiv.org/abs/2308.07327).
...
* [TexasSolver](https://github.com/bupticybee/TexasSolver) ⭐ 2,512 | 🐛 90 | 🌐 C++ | 📅 2026-07-13 — Free open-source Texas Hold'em GTO solver with a GUI (Windows/macOS/Linux); performance comparable to PioSOLVER. [Website](https://bupticybee.github.io/texassolver_page/).
