...
* [OpenSpiel](https://github.com/google-deepmind/open_spiel) ⭐ 5,478 | 🐛 55 | 🌐 C++ | 📅 2026-08-31 — Google DeepMind's collection of environments and algorithms for RL research in games, with extensive poker support (Kuhn, Leduc, ACPC universal poker interface) and CFR/MCCFR implementations.
...
* [PokerKit](https://github.com/uoftcprg/pokerkit) ⭐ 496 | 🐛 2 | 🌐 Python | 📅 2026-08-22 — Comprehensive Python library supporting Texas Hold'em, Omaha, Stud, Razz, and custom game variants (University of Toronto). [Paper](https://arxiv.org/abs/2308.07327).
