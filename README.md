...
* [OpenSpiel](https://github.com/google-deepmind/open_spiel) ⭐ 5,484 | 🐛 55 | 🌐 C++ | 📅 2026-08-31 — Google DeepMind's collection of environments and algorithms for RL research in games, with extensive poker support (Kuhn, Leduc, ACPC universal poker interface) and CFR/MCCFR implementations.
...
* [PokerHandEvaluator](https://github.com/HenryRLee/PokerHandEvaluator) ⭐ 516 | 🐛 8 | 🌐 C | 📅 2026-09-14 — High-performance C/C++ evaluator using a perfect hash algorithm; supports 5-7 card hands and Omaha (PLO4/5/6). Python bindings available.
